...
//     const [result] = await client.labelDetection('./imagem.jpg');
...
ytdl('https://youtube.com/shorts/fZQIUoya1FE?feature=share', { filter: 'videoandaudio' })
  .pipe(fs.createWriteStream('video.mp4'))

// const host = hostNameVideoApp("https://youtu.be/bMtvbLvKX5I")
